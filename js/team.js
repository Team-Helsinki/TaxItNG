...
const set1 = members.slice(0,9);
const set2 = members.slice(10,20);
const set3 = members.slice(21,31);
const set4 = members.slice(31,42);
const set5 = members.slice(43,54);
...
function generateTeam2() {
    let teamMembers = document.getElementById("team-members")
    return set2.map(member => {
        teamMembers.appendChild(createMember(member))
...
function generateTeam3() {
    let teamMembers = document.getElementById("team-members")
    return set3.map(member => {
        teamMembers.appendChild(createMember(member))
...
function generateTeam4() {
    let teamMembers = document.getElementById("team-members")
    return set4.map(member => {
        teamMembers.appendChild(createMember(member))
...
function generateTeam5() {
    let teamMembers = document.getElementById("team-members")
    return set5.map(member => {
        teamMembers.appendChild(createMember(member))
